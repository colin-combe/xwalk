...
public class GridUtilities {
     ...
     * @see xwalk.math.algorithms.BoundarySearch
     */
    ...
    public static void main(final String[] args) {
        ...
        try {
            reader = new PDBreader(args[0]);
        } catch (Exception e) {
            System.out.print("ERRROROROR\n" + e + "\n");
        }
        AtomList list = reader.getEntireProteinComplex().get(0).
                                           getAminoAcids().get(0).getAllAtoms();
        AtomGrid grid = new AtomGrid(list, 0.5, 1.0, false);
//        SolventPathDistance dist = new SolventPathDistance(atom1cell, 
                                                            //atom2cells, grid)
        grid.toString();
